...
parser.add_argument('--model_name',                type=str,   help='model name', default='pydnet')
parser.add_argument('--encoder',                   type=str,   help='type of encoder, vgg or resnet50', default='vgg')
parser.add_argument('--dataset',                   type=str,   help='dataset to train on, kitti, or cityscapes', default='kitti')
parser.add_argument('--data_path',                 type=str,   help='path to the data', default="/MLDatasetsStorage/exjobb/KITTI/KITTI_stereo/")
parser.add_argument('--filenames_file',            type=str,   help='path to the filenames text file', default="/home/exjobb/DSegNet/pydnet/training_code/utils/filenames/KITTI_stereo_train.txt")
...
parser.add_argument('--log_directory',             type=str,   help='directory to save checkpoints and summaries',
                    default='/home/exjobb/DSegNet/pydnet/checkpoint')
